...
'@
  ...
  Assert-AkashaContains -Text $changelog -Expected '## 0.4.4 - 2026-08-06' -Context 'CHANGELOG.md'
  $version = (Read-AkashaUtf8Strict -Path (Join-Path $root 'VERSION')).Trim()
  if ($version -cne '0.4.4') {
    throw "Documentation/layout gate: VERSION must be 0.4.4, found '$version'."
  }
